...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DVORAK] = KC_KEYMAP(
  //,----+----+----+----+----+----.    ,----+----+----+----+----+----.
     SLSH, L  ,  R , C  , G  , F  ,      Y  , P  ,DOT ,COMM,QUOT,MESC,
  //|----+----+----+----+----+----|    |----+----+----+----+----+----|
     ENT , S  , N  , T  , H  , D  ,      I  , U  , E  , O  , A  ,TAB ,
  //|----+----+----+----+----+----|    |----+----+----+----+----+----|
     RSPC, Z  , V  , W  , M  , B  ,      X  , K  , J  , Q  ,SCLN,LSPO,
  //|----+----+----+----+----+----|    |----+----+----+----+----+----|
     GBRC,LBRC,EXLM,ASTR,SYMB,SPC ,     BSPC,NMPD,AMPR,SPLT,SPFN,SPCT
  //`----+----+----+----+----+----'    `----+----+----+----+----+----'
  ),
  ...
  //|----+----+----+----+----+----|    |----+----+----+----+----+----|
     EQL ,ASTR, 3  , 2  , 1  ,    ,         ,    ,    ,    ,    ,LSFT,
  //|----+----+----+----+----+----|    |----+----+----+----+----+----|
     RGUI,SLSH, DOT, 0  , 0  , SPC,     BSPC,    ,    ,    ,    ,    
  //`----+----+----+----+----+----'    `----+----+----+----+----+----'
  ),

  [_SYMBOLS] = KC_KEYMAP(
  //,----+----+----+----+----+----.    ,----+----+----+----+----+----.
     SLSH,RPRN,LPRN,ASTR,AMPR,CIRC,     PERC,DLR ,HASH, AT ,EXLM,    ,
  //|----+----+----+----+----+----|    |----+----+----+----+----+----|
     PIPE,RCBR,LCBR,UNDS,EQL ,TILD,      F6 , F5 , F4 , F3 , F2 , F1 ,
  //|----+----+----+----+----+----|    |----+----+----+----+----+----|
     BSLS,RBRC,LBRC,MINS,PLUS,GRV ,     F12 ,F11 ,F10 , F9 , F8 , F7 ,
  //|----+----+----+----+----+----|    |----+----+----+----+----+----|
     RGUI,    ,    ,    ,    ,SPC ,     BSPC, NO ,    ,    ,    ,RGUI
  //`----+----+----+----+----+----'    `----+----+----+----+----+----'
  ),
/****************** STOPPED HERE ************************************/
  [_FN] = KC_KEYMAP(
